...
export namespace RNMapsHeatmap {
  export const NAME = "RNMapsHeatmap" as const
  ...
  export class PropsSelector extends ViewPropsSelector<Props, RawProps> {
    get points() {
      return this.rawProps.points;
    }
    
    get radius() {
      return this.rawProps.radius ?? 20;
    }
    
    get opacity() {
      return this.rawProps.opacity ?? 0.6;
    }
    
    get gradient() {
      return this.rawProps.gradient;
    }
