...
export namespace RNMapsCircle {
  export const NAME = "RNMapsCircle" as const
  ...
  export class PropsSelector extends ViewPropsSelector<Props, RawProps> {
    ...
    get fillColor() {
        if (this.rawProps.fillColor) {
          return Color.fromColorValue(this.rawProps.fillColor)
        } else {
          return new Color({ r: 0, g: 0, b: 0, a: 255})
        }
    }
